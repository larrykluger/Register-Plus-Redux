...
if ( !class_exists( 'RPR_Login' ) ) {
	class RPR_Login {
		function __construct() {
			...
			add_action( 'register_form', array( $this, 'rpr_register_form' ), 9, 1); // Higher priority to avoid getting bumped by other plugins
			...
			add_action( 'login_head', array( $this, 'rpr_login_head' ), 10, 1 );
			add_action( 'login_footer', array( $this, 'rpr_login_footer' ), 10, 1 ); // Hides user_login, changed username to e-mail
